function headToHead(team_select,team_select_comp) {
    ...
    //     data_table[i]["team"] = "<img src='/img/Uefa Logos/" + team + ".png'" + "</img>&nbsp;" + team
    // }
    // console.log(data_table)    
    // $('#elo-ranking tbody tr').each(function(){
    //     team = $(this).find("td").eq(1).text()
    //     $(this).find("td").eq(1).html("<img src='/img/Uefa Logos/" + team + ".png'" + "</img>&nbsp;" + team)
    // })
...
function drawEloChart(team_select,team_select_comp) {
   ...
   // Get data via AJAX call
    ...
    url_select = "http://www.sway-blog.be/data/elo-uefa-football/teams/" + team_select + ".json"
    ...
    if (team_select_comp == "") {
        ...
        url_select_comp = "http://www.sway-blog.be/data/elo-uefa-football/teams/" + team_select_comp + ".json"
   ...
   $.when(ajax_call_select,ajax_call_select_comp ).done(function(data1, data2){
    ...
    xAxis_options = {
            ...
            tickPositioner: function() {
                if ($("#article").width() > 800) {
                    number_of_ticks = 6
                    tickPositions = [date_index["1959-60"][Math.round(date_index["1959-60"].length/2)],
                            date_index["1969-70"][Math.round(date_index["1969-70"].length/2)],
                            date_index["1979-80"][Math.round(date_index["1979-80"].length/2)],
                            date_index["1989-90"][Math.round(date_index["1989-90"].length/2)],
                            date_index["1999-00"][Math.round(date_index["1999-00"].length/2)],
                            date_index["2009-10"][Math.round(date_index["2009-10"].length/2)]]
                }
                else {
                    number_of_ticks = 3
                    tickPositions = [date_index["1959-60"][Math.round(date_index["1959-60"].length/2)],
                            date_index["1985-86"][Math.round(date_index["1985-86"].length/2)],
                            date_index["2009-10"][Math.round(date_index["2009-10"].length/2)]]
                }
            ...
            labels: {
                formatter: function() {
                    if (this.value == date_index["1959-60"][Math.round(date_index["1959-60"].length/2)]) {
                        date_string = "<a>" + "Seizoen" + "</a><br><a>" + "1959-60" + "</a>"
                    } else {
    ...
    xAxis_options_navigator = {
            ...
            tickPositions: [date_index["1959-60"][Math.round(date_index["1959-60"].length/2)],
                            ...
                            date_index["1989-90"][Math.round(date_index["1989-90"].length/2)],
                            date_index["1999-00"][Math.round(date_index["1999-00"].length/2)],
                            date_index["2009-10"][Math.round(date_index["2009-10"].length/2)]], // 01/01/1996 - 01/01/2001 - ...
            type: 'datetime',
            ...
            labels: {
                ...
                formatter: function() {
                    ...
                    else if (this.value == date_index["1969-70"][Math.round(date_index["1969-70"].length/2)]) {
                        date_string = "1970"
                    }
                    else if (this.value == date_index["1979-80"][Math.round(date_index["1979-80"].length/2)]) {
                        date_string = "1980"
                    } 
                    else if (this.value == date_index["1989-90"][Math.round(date_index["1989-90"].length/2)]) {
                        date_string = "1990"   
                    }
                    else if (this.value == date_index["1999-00"][Math.round(date_index["1999-00"].length/2)]) {
                        date_string = "2000"   
                    }   
                    else if (this.value == date_index["2009-10"][Math.round(date_index["2009-10"].length/2)]) {
                        date_string = "2010"   
                    }
                    return date_string;
                    }
